...
def build_payload(
    repository_path: Path, review_mode: str = "latest", custom_diff: str | None = None
) -> ReviewRequest:

    git_data = collect_git_data(repository_path)
    ...
    metrics_data = collect_metrics(repository_path)
